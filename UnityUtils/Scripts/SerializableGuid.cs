...
namespace UnityUtils
{
    ...
    {
        [SerializeField, ReadOnly] public uint Part1;
        [SerializeField, ReadOnly] public uint Part2;
        [SerializeField, ReadOnly] public uint Part3;
        [SerializeField, ReadOnly] public uint Part4;
